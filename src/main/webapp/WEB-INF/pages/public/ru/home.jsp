...
<head>
    ...
    <%--&lt;%&ndash;<script type="text/javascript" src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>&ndash;%&gt;--%>
    ...
    <%--&lt;%&ndash;<link rel="stylesheet"&ndash;%&gt;--%>
          <%--&lt;%&ndash;href="http://cdnjs.cloudflare.com/ajax/libs/jquery.bootstrapvalidator/0.5.0/css/bootstrapValidator.min.css"/>&ndash;%&gt;--%>
    <%--<script type="text/javascript"--%>
    ...
    <%--&lt;%&ndash;<link rel="stylesheet" href="${pageContext.request.contextPath}/css/jquery-ui.css">&ndash;%&gt;--%>
    ...
    <%--&lt;%&ndash;<link rel="stylesheet" href="${pageContext.request.contextPath}/css/content.css"/>&ndash;%&gt;--%>

    <%--<script type="text/javascript" src="${pageContext.request.contextPath}/js/modalWindows.js"></script>--%>
    <%--&lt;%&ndash;<link rel="stylesheet" href="${pageContext.request.contextPath}/css/modalWindows.css">&ndash;%&gt;--%>
